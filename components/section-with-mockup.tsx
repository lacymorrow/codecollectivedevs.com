    ...
    <section className="relative py-24 md:py-48 bg-black overflow-hidden">
      <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
        ...
        >
          {/* Text Content */}
          <motion.div
            className={`flex flex-col items-center gap-4 mt-10 md:mt-0 max-w-[546px] mx-auto ${textOrderClass}`}
            variants={itemVariants}
          >
            <div className="space-y-2 md:space-y-1 text-center">
              <h2 className="text-white text-3xl md:text-[40px] font-semibold leading-tight md:leading-[53px]">
                {title}
              </h2>
            </div>

            <p className="text-[#868f97] text-sm md:text-[15px] leading-6 text-center">
              {description}
            </p>
