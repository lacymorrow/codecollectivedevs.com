              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-zinc-600 leading-relaxed">
                    How we built a modern headless e-commerce platform using Swell that processes $2M+ in monthly
                    transactions and increased sales by 60% in the first quarter.
                  </p>
                </div>
            ...
            <div className="grid gap-16 lg:grid-cols-2">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-zinc-600 leading-relaxed">
                  <p>
                    Artisan Marketplace was running on a legacy e-commerce platform that was limiting their growth
                    potential. Their existing system had several critical issues:
                  </p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-zinc-600 leading-relaxed">
                  <p>
                    We implemented a modern headless e-commerce solution using Swell as the backend and a custom Next.js
          ...
          <div className="container px-4 md:px-6">
            <div className="space-y-12">
              <div className="text-center space-y-4">
                <h2 className="text-2xl font-bold tracking-tight text-zinc-900">Measurable Results</h2>
                <p className="text-zinc-600 max-w-2xl mx-auto">
                  The new platform delivered exceptional results across all key performance indicators within 90 days.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-zinc-900 mb-4">
                      "The new platform exceeded all our expectations. We've seen incredible growth and our customers
                      love the experience."
                    </div>
                  </div>
                  <div className="flex items-center justify-center gap-4">
                    <Image src="/client-2.png" alt="Marcus Rodriguez" width={64} height={64} className="rounded-full" />
                    <div className="text-center">
        ...
        <section className="w-full py-16 bg-zinc-900 text-white">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-6">
              <h2 className="text-2xl font-bold tracking-tight">Ready to transform your e-commerce platform?</h2>
              <p className="text-zinc-300 max-w-2xl mx-auto">
                Let's discuss how we can help you build a modern, high-performing e-commerce solution.
              </p>
